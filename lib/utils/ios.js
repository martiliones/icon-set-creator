...
exports.createIosIcons = (imagePath, ios, flavor, context) => {
  return new Promise((resolve, reject) => {
    ...
    fs.readFile(imagePath, async (err, image) => {
      ...
      await changeIosLauncherIcon(catalogName, context, projectName, flavor);
...
exports.getProjectName = function getProjectName(context) {
...
exports.changeIosLauncherIcon = function changeIosLauncherIcon(iconName, context, projectName, flavor) {
  return new Promise((resolve, reject) => {
